...
<div class="box">
    ...
    <div class="body">
        <form class="form-horizontal" action="/admin/categories/update" method="post" enctype="multipart/form-data" >
            {{ csrf_field() }}
            <input name="ID_DANHMUC" value="{{ $new->ID_DANHMUC }}" type="hidden" />
            <div class="form-group">
                ...
                <div class="col-lg-4">
                        ...
                        <select name="FK_DANHMUC" class="form-control">
                            ...
                            <option value="{{$row->ID_DANHMUC}}" {{ $row->ID_DANHMUC == $new->FK_DANHMUC ? "selected" : "" }} >{{$row->TEN}}</option>
                            @endif
                            @endforeach
                        </select>
